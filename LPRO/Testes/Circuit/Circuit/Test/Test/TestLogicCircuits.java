...
public class TestLogicCircuits {
	...
	public void testColision() throws Exception {
		...
		System.out.println("OI cheguei aqu3 :) " ); //ate aqui criei variaveis
	}
	...
	public void testFormulas() throws Exception {
		...
		assertEquals("NOT(OR(AND(X1,X2),X3))", Y1.getFormula());//System.out.println("Y1F " + W1.getFormula());
		assertEquals("NOT(OR(AND(X1,X2),X3))", p3.getFormula());//System.out.println("P3F " + p3.getFormula());
	}
	...
	public void testValues() throws Exception {
		...
		assertEquals(false, W1.getValue()); System.out.println("PASSED here " + W1.getValue());
