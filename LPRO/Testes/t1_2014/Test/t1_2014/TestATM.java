...
public class TestATM {
	...
	public void testSession() {		
		ATM atm = new ATM(997, "Porto", "CGD");
		Session s = new Session(new ATM(987, "Porto", "CGD"));	//System.out.println("prox " + (s.getATM()).getID());
	...
	*/
	...
	public void testCountable() {
		...
		s.addTransaction(w);
		s.addTransaction(d);
		Countable sessionCount = s;	System.out.println("prox " + sessionCount.count());
